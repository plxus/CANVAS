...
<head>
  <meta charset="utf-8">
  <title>发布作品 - CANVAS</title>
  <link type="text/css" rel="stylesheet" href="post_work.css" media="screen">
...
EOD;
  ...
  <div id="all-content">
    ...
    <div id="box">
      ...
      <?php
        if(isset($username)) echo '<input type="submit" form="post_work" name="submit_post" value="确认发布" onclick="submit_post()">';
    ...
    <div id="post_edit">
      ...
      <form name="post_work" id="post_work" action="post_work.php" method="post" enctype="multipart/form-data">
        ...
        <div id="post_table">
          ...
          <div class="post_row">
            ...
            <div class="post_cell">
              <input type="text" class="input_title" name="title" value="" required>
          ...
          <div class="post_row">
            ...
            <div class="post_cell">
              <select name="category_small" size="1" required style="width:150px;">
        ...
        <input type="hidden" name="category_large" value="作品">
...
EOD;
            ...
            $imagename_pre=$filename_new; //作品内容图像的文件夹名（前导）
            ...
            $savedir="/Applications/XAMPP/xamppfiles/htdocs/canvas/create/work/".$cover_name; //保存目录
...
EOD;
            ...
            foreach($_FILES['create_images']['name'] as $name){
              if($_FILES['create_images']['size'][$i]<5000*1000){
                $savedir_temp="/Applications/XAMPP/xamppfiles/htdocs/canvas/create/work/$imagename_pre/"; //图片保存的文件夹
                ...
                $savedir_images=$savedir_temp.$images_name; //作品内容的保存目录

                if(!move_uploaded_file($_FILES["create_images"]["tmp_name"][$i],$savedir_images)){
                    $isok=0;
                    echo <<<EOD
                      <p class="notice_fail">上传作品内容失败：无法将文件写入服务器。</p>
EOD;
                  }
                $i=$i+1;
              }
                ...
                $isok=0;
                echo <<<EOD
                <p class="notice_fail">请上传有效的作品内容！</p>
EOD;
}
            }
          }
